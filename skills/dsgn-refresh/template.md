...
**Locked** means hard to change without eng or product cost: required steps, roles, persisted data, must-not-break behavior.
**Flexible** means presentation, copy, layout, empty and error framing that design can reshape.
